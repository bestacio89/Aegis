...
namespace Aegis.Core.Architecture.Evaluators.DesignPatterns;
...
public sealed class StrategyPatternEvaluator : BaseArchitectureEvaluator
{
    ...
    public StrategyPatternEvaluator(ILogger<StrategyPatternEvaluator> logger, IOptions<AegisArchitecturePolicy> options)
        : base(logger)
    {
