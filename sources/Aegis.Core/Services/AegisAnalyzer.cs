...
/// </summary>
public sealed class AegisAnalyzer
{
    ...
    private readonly ILogger<AegisAnalyzer> _logger;

    public AegisAnalyzer(
        IEnumerable<IEvaluator> evaluators,
        CrossEvaluatorAggregator aggregator,
        RuleWeightingEngine weighting,
        ILogger<AegisAnalyzer> logger)
    {
    ...
    public async Task<AegisReport> AnalyzeAsync(string projectPath, CancellationToken token = default)
    {
        ...
        var allResults = new List<EvaluatorResult>();
    ...
    private static EvaluatorResult BuildContextFact(ProjectContext context)
    {
        ...
        return new EvaluatorResult("ProjectContextFact", context.RootPath)
        {
