...
public sealed class ProjectArchitectureContext
{
    ...
    public ProjectArchitectureMetadata? Metadata { get; set; }
    public List<ArchitectureInferenceTrace> InferenceHistory { get; set; } = new();
    // 🧾 Constructors
    public ProjectArchitectureContext() { }

    public ProjectArchitectureContext(string language, string? framework, double confidence)
    {
        Language = language;
        Framework = framework;
