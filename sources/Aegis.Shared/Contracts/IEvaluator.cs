...
public interface IEvaluator : IScopedDependency
{
    ...
    /// Can be toggled dynamically via the active <see cref="AegisArchitecturePolicy"/>.
    /// </summary>
    ...
    /// Produces structured <see cref="ArchitectureEvaluatorResult"/> data, not direct rule evaluations.
    /// </summary>
    ...
    /// <returns>Collection of <see cref="ArchitectureEvaluatorResult"/> metrics generated by the evaluator.</returns>
    Task<IEnumerable<ArchitectureEvaluatorResult>> EvaluateAsync(
        string projectPath,
